...
class RscStrategicMap
{
	...
	OnLoad = QT _dummy = [_this, CA_ActiveMission1_enabled,  CA_ActiveMission2_enabled, CA_ActiveMission3_enabled,  CA_ActiveMission4_enabled, CA_ActiveMission1_variable,CA_ActiveMission2_variable,CA_ActiveMission3_variable,CA_ActiveMission4_variable] execVM  ""strategyMapInit.sqf"";  10 execVM ""missionselect.sqf"";QT;
	...
	class Controls
	{
		...
		class Map : RscText
		{
			...
			w = 0.625;
			h = "640/768";
			action = "0 execVM ""missionselect.sqf""";
			text = CA_Mission_Map;
			colorText[] = {1,1,1,1};
			colorActive[] = {1,1,1,1};
			color[] = {1,1,1,1};
		...
		class ActiveMission1 : RscActiveText
		{
			...
			text = "m1_icon.paa";
			action = "1 execVM ""missionselect.sqf""";
			SizeEx = 0.030000;
			ColorText[] = {1,1,1,0.8};
			colorActive[] = {1,1,1,1};
		};
		class ActiveMission2 : ActiveMission1
		{
			...
			text = "m2_icon.paa";
			action = "2 execVM ""missionselect.sqf""";	
		};		
		class ActiveMission3 : ActiveMission1
		{
			...
			text = "m3_icon.paa";
			action = "3 execVM ""missionselect.sqf""";		
		};
		class ActiveMission4 : ActiveMission1
		{
			...
			text = "m4_icon.paa";
			action = "4 execVM ""missionselect.sqf""";	
		};
